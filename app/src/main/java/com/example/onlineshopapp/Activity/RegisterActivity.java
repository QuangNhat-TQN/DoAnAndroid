...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText edtFullName, edtEmail, edtPassword, edtPhone, edtAddressDetail;
    Button btnRegister;
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    if (user != null) {
                                        ...
                                        String addressKey = usersRef.child(userId).child("address").push().getKey();
                                        addressMap.put(addressKey, new Address(addressDetail, fullName, phone));

                                        Users newUser = new Users(addressMap, email, fullName, phone, "", "customer");
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            Address newAddress = new Address(addressDetail, fullName, phone);
                                                            addressRef.child(addressId).setValue(newAddress);
