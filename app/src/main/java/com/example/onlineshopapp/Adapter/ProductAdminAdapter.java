...
public class ProductAdminAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public ProductAdminAdapter(Context context, List<Product> dataList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_product_admin_item, parent, false);
