                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                ordersRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        boolean productInOrders = false;
                                        for (DataSnapshot orderSnapshot : dataSnapshot.getChildren()) {
                                            Map<String, Object> order = (Map<String, Object>) orderSnapshot.getValue();
                                            if (order != null && order.containsKey("products")) {
                                                Map<String, Object> products = (Map<String, Object>) order.get("products");
                                        ...
                                        if (productInOrders) {
                                            Toast.makeText(AdminProductDetailActivity.this, "Sản phẩm này tồn tại trong đơn hàng, không thể xóa.", Toast.LENGTH_SHORT).show();
                                        } else {
                                    ...
                                    public void onCancelled(@NonNull DatabaseError databaseError) {
                                        Toast.makeText(AdminProductDetailActivity.this, "Lỗi khi kiểm tra đơn hàng.", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        })
