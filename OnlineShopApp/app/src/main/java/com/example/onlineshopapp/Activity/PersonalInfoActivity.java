        ...
        if (uri != null) {
            ...
            storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    uploadData(imageURL, dialog, email, fullName, phone);
                }
            ...
            uploadData(oldImageURL, dialog, email, fullName, phone);
        }
    }

    public void uploadData(String imageUrl, AlertDialog dialog, String email, String fullName, String phone){
        Users user = new Users(address, email, fullName, phone, imageUrl, role);
